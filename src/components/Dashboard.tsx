...
// ---- slug helper (or import from utils/slug) ----
...
const Dashboard = () => {
  ...
  const handleFeatureClick = (featureId: string) => {
    if (featureId === "medication") {
      ...
      console.log("[Dashboard] navigate →", `/patients/${slug}/medication_summary`);
  ...
  // 🔎 Debug: selection flow
  // eslint-disable-next-line no-console
  console.log("[Dashboard] selectedItem (MRN) =", selectedItem);
  // eslint-disable-next-line no-console
  console.log("[Dashboard] selectedItemData =", selectedItemData);
